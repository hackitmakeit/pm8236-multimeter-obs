  ...
  <body>
    <table border="0" style="font-family:verdana;">
      <tr style="height:15px;">        
        <td rowspan="2" id="value" style="padding:1px; width:140px; text-align: center; font-size:36px; background: rgba(250, 250, 250, 0.5)"></td>
        <td id="units" style="padding:2px; font-size:16px; background-color: #D7EEFF"></td>
      </tr>
      <tr style="height:15px;">
        <td id="modes" style="padding:2px; font-size:12px; background-color: #D7EEFF"></td>
      </tr>
    </table>
    <script>
