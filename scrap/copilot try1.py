...
<html>
  ...
  <body>
    <table border="0" style="font-family:verdana;">
      <tr>        
        <td rowspan="2" id="value" style="padding:2px; width:130px; text-align: center; font-size:40px; background-color: #FFCCE1"></td>
        <td id="units" style="padding:2px; font-size:12px; background-color: #D7EEFF"></td>
      </tr>
      <tr>
